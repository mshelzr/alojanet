	...
	<div class="modal fade" id="modalDetalleReserva" tabindex="1"
		...
		<div class="modal-body">
		 <form>
				...
				<tr>
					<td>
						<div class="input-group date " id="e" data-date="16-01-2014"
							...
							<span class="input-group-addon">Desde</span> <input disabled
					...
					<td>
						<div class="input-group date " id="e2" data-date="16-02-2014"
							data-date-format="dd-mm-yyyy">
							<span class="input-group-addon">Hasta</span> <input disabled
					...
					<div class="input-group">
						<span class="input-group-btn"> <select class="input-sm"
							...
							<input type="submit" class="hidden" id="btnAgregarAcomp" />
							 ...
							 <a href="javascript:void(0);" onclick="$('#btnAgregarAcomp').trigger('click');" 
							id="btnAddAcomp"> <span class="glyphicon glyphicon-plus"></span>
			...
			<div class="row" id="rowInputNumTarjeta">
				<div class="col-md-6 col-md-offset-3 col-xs-5">
					<div class="input-group input-group-lg">
						<span class="input-group-addon">Nº Tarjeta</span> <input
							type="text" class="form-control" id="numeroTarjeta" />
					</div>
				</div>
			</div>
			<input type="submit" class="hidden" id="btnSaveModalCheckIn" />
			</form>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-danger" data-dismiss="modal"
				onclick="$('#btnSaveModalCheckIn').trigger('click');">Check In</button>
			<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
		</div>
	</div>
	<div class="row">
